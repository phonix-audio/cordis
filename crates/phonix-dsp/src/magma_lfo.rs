//! Magma LFO — tempo-syncable, retriggerable, six shapes.
//!
...
/// LFO shape. Moved here with `MagmaLfo` (it was `magma::patch::LfoShape`)
/// so this generator is self-contained; re-exported from its old path.
