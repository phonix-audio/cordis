//! Meters for audio level and CPU usage monitoring
//!
//! This module provides VU meters for audio level visualization and
//! CPU usage meters for performance monitoring.
