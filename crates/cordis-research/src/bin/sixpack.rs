...
//! host's layout.
//!
//!   cargo run --release -p cordis-research --bin sixpack
...
/// The host's own sub-block: what a Cordis instance is actually handed.
...
fn run_instance(
    ...
    for b in 0..blocks {
        ...
        if hit {
            ...
            let _ = tx.send(CordisCommand::NoteOn(n.min(105), 96));
        }
